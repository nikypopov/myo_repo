...
# **********************************************************************************
# * NOTE: This script requires Python 3.8 or later. Make sure to activate the       *
# * appropriate conda environment before running the script.                       *
# **********************************************************************************
...
def helper_env_loop(env):
    ...
    for ep in range(10):
        ...
        for i in range(2000):
            ...
            env.mj_render() #uncomment to render GUI and visualize
            ret += reward
